...
**Ulrich**: FFT algorithm, phong model, Bezier Curves, Project setup <br>
**Mathieu**: Camera, Project updates & website, Codebase management, Performance issues, Final Video & report <br>
